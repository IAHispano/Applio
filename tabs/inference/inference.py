...
def inference_tab():
    ...
    params_batch = {
        ...
        "filter_radius_batch": filter_radius_batch,
        "index_rate_batch": index_rate_batch,
        "rms_mix_rate_batch": rms_mix_rate_batch,
        "protect_batch": protect_batch,
        "hop_length_batch": hop_length_batch,
        "f0_method_batch": f0_method_batch,
        "input_folder_batch": input_folder_batch,
        "output_folder_batch": output_folder_batch,
        "model_file": model_file,
        "index_file": index_file,
        "split_audio_batch": split_audio_batch,
        "autotune_batch": autotune_batch,
        "clean_audio_batch": clean_audio_batch,
        "clean_strength_batch": clean_strength_batch,
        "export_format_batch": export_format_batch,
        "upscale_audio_batch": upscale_audio_batch,
        "f0_file_batch": f0_file_batch,
        "embedder_model_batch": embedder_model_batch,
