...
recorder_js_path = os.path.join(os.getcwd(), "tabs", "report", "recorder.js")
main_js_path = os.path.join(os.getcwd(), "tabs", "report", "main.js")
record_button_js_path = os.path.join(os.getcwd(), "tabs", "report", "record_button.js")
