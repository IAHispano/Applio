...
def update_model_settings(learning_rate, p_dropout, use_spectral_norm, precision):
    try:
    ...
    with gr.Row():
        with gr.Column():
            ...
            use_spectral_norm = gr.Checkbox(
                ...
                info=i18n(
                    "Enabling this setting will make training more stable, lower computational needs and handle higher learning rates"
                ),
            ...
            update_button.click(
                ...
                inputs=[learning_rate, p_dropout, use_spectral_norm, precision],
                outputs=[output],
            )